...
visAgeUKValid <- function(data, cd, gender, path = '/home/luke/Documents/WORK/E_FEM/Deliverables/IJM_Feb22/figures/validation/ageUK') {
...
c_rep <- read_dta('output/SCENARIO/ELSA_core_cohort/ELSA_core_cohort_by_rep.dta')
...
```{r}
b <- read_dta('/home/luke/Documents/E_FEM_clean/E_FEM/output/SCENARIO/ELSA_core_base/ELSA_core_base_summary.dta')
h <- read_dta('/home/luke/Documents/E_FEM_clean/E_FEM/output/SCENARIO/ELSA_core_remove_hearte_p/ELSA_core_remove_hearte_p_summary.dta')
new.df <- data.frame(b$year, b$d_age_all, h$d_age_all)
new.df$diff <- new.df$h.d_age_all - new.df$b.d_age_all
new.df
```
