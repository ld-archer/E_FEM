...
vis_CV2_prev <- function(long, CV2, path) {
  ...
  cd_l2 <- select(l2, c(year, cancre, diabe, hearte, lunge, smoken, bmi, work, anyadl, anyiadl)) #, adl1, adl2, adl3p))
  cd_CV2 <- select(CV2, c(year, p_cancre_all, p_diabe_all, 
                            p_hearte_all, p_lunge_all, p_smoken_all, 
                            a_bmi_all, p_work_all,  p_anyadl_all, p_anyiadl_all))
                            #p_adl1_all, p_adl2_all, p_adl3p_all))
  
  CV2_rename <- cd_CV2 %>% dplyr::rename('cancre' = p_cancre_all, 
                                        'diabe' = p_diabe_all, 
                                        'hearte' = p_hearte_all,
                                        'lunge' = p_lunge_all,
                                        'smoken' = p_smoken_all,
...
CV2 <- read_dta('ELSA_CrossValidation2/ELSA_CrossValidation2_summary.dta')
