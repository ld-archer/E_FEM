...
pop <- read_dta('output/ELSA_Baseline/ELSA_Baseline_summary.dta')
ep10 <- read_dta('output/ExstatP10/ExstatP10_summary.dta')
ep50 <- read_dta('output/ExstatP50/ExstatP50_summary.dta')
ep80 <- read_dta('output/ExstatP80/ExstatP80_summary.dta')
