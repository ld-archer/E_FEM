...
# Cross Validation 2 - 'Handover' plots
...
vis_CV2_prev <- function(long, CV2) {
  ...
  cd_l2 <- select(l2, c(year, age, cancre, diabe, hearte, lunge, smoken, bmi, work, anyadl)) #, anyiadl, adl1, adl2, adl3p))
  cd_CV2 <- select(CV2, c(year, a_age_all, p_cancre_all, p_diabe_all, 
                            p_hearte_all, p_lunge_all, p_smoken_all, 
                            a_bmi_all, p_work_all,  p_anyadl_all))
