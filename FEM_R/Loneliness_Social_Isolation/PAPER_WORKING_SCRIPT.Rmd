...
ly.change <- ly.all %>%
 ...
 # %>%
 #  mutate(L_min = L - margin_No_Loneliness,
 #         L_max = L + margin_No_Loneliness,
 #         S_min = S - margin_No_Social_Isolation,
 #         S_max = S + margin_No_Social_Isolation,
 #         LS_min = LS - margin_Neither,
 #         LS_max = LS + margin_Neither)




#ggplot(data = ly.change, aes(x = outcome, y = LifeYears, fill = scenario)) +
  #geom_col(position = 'dodge', stat = 'identity') +
  #geom_errorbar(ymin = (LifeYears - margin), ymax = (LifeYears + margin))
```
