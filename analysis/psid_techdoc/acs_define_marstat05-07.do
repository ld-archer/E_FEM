...
(single, married, cohab) to match the categories in FAM/PSID.  This is for 2005-2007 data. (ACS years 2005-7 use '10' instead of '13' in years 2008-2012 for unmarried partner in variable "Rel"). Other ACS years might 
not have the same 
*/
