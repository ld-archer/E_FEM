...
local ster "/Estimates/" /* ster file for storing estimates */
...
global bin_hlth cancre diabe hearte hibpe lunge stroke arthre psyche died asthmae parkine drink smoke_start smoke_stop smoken smokev smoke_start smoke_stop
...
global allvars_psyche male hsless college l2age65l l2age6574 l2age75p l2hearte l2stroke l2cancre l2hibpe l2diabe l2logbmi l2smokev l2smoken l2work l2drink l2drinkd l2drinkd1 l2drinkd2 l2drinkd3 l2drinkd4
global allvars_asthmae male hsless college l2age65l l2age6574 l2age75p l2logbmi l2lunge l2logbmi l2smokev l2smoken l2smokef /*https://www.healthline.com/health/understanding-idiopathic-pulmonary-fibrosis/chronic-lung-diseases-causes-and-risk-factors#1*/
...
* Drinking
global allvars_drink male hsless college l2age65l l2age6574 l2age75p l2hearte l2stroke l2cancre l2hibpe l2lunge l2logbmi l2work l2adl1 l2adl2 l2adl3p l2iadl1 l2iadl2p l2psyche l2arthre l2parkine
global allvars_drinkd_stat male hsless college l2age65l l2age6574 l2age75p l2hearte l2stroke l2cancre l2hibpe l2lunge l2logbmi l2work l2adl1 l2adl2 l2adl3p l2iadl1 l2iadl2p l2psyche l2arthre l2parkine
global allvars_drinkd male hsless college l2age65l l2age6574 l2age75p l2hearte l2stroke l2cancre l2hibpe l2lunge l2logbmi l2work l2adl1 l2adl2 l2adl3p l2iadl1 l2iadl2p l2psyche l2arthre l2parkine

global allvars_work male hsless college l2age65l l2age6574 l2age75p l2hearte l2stroke l2cancre l2hibpe l2diabe l2lunge l2logbmi l2work l2adl1 l2adl2 l2adl3p l2iadl1 l2iadl2p l2psyche l2arthre l2parkine l2drink
global allvars_hlthlm male hsless college l2age65l l2age6574 l2age75p hearte stroke cancre hibpe diabe lunge logbmi adl1 adl2 adl3p iadl1 iadl2p smokev smoken arthre psyche asthmae parkine drink drinkd1 drinkd2 drinkd3 drinkd4
...
global allvars_logbmi male hsless college l2age65l l2age6574 l2age75p l2logbmi l2cancre l2diabe l2hearte l2hibpe l2lunge l2stroke l2adl1 l2adl2 l2adl3p l2iadl1 l2iadl2p l2smoken l2psyche l2arthre l2asthmae l2parkine l2smokef l2drinkd1 l2drinkd2 l2drinkd3 l2drinkd4
...
foreach var in adlstat iadlstat smkstat work retemp atotf itearn drink vgactx_e mdactx_e ltactx_e smoken smokev {
...
local select_logbmi !died & (wave==2 | wave==4 | wave==6) /* Only estimate bmi model using waves 2,4,6,8 as other waves are imputed */
