...
//	info[Vars::sssage]               = VarInfo("sssage", "Year spouse started claiming SS benefits", VarTypes::Short);
    ...
    info[Vars::pworkstat1]           = VarInfo("pworkstat1", "Probability of employed (workstat == 1)", VarTypes::Double);
    info[Vars::pworkstat2]           = VarInfo("pworkstat2", "Probability of unemployed (workstat == 2)", VarTypes::Double);
    info[Vars::pworkstat3]           = VarInfo("pworkstat3", "Probability of retired (workstat == 3)", VarTypes::Double);
