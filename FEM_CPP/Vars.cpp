...
//	info[Vars::sssage]               = VarInfo("sssage", "Year spouse started claiming SS benefits", VarTypes::Short);
    ...
    info[Vars::cesd1]                   = VarInfo("cesd1", "Cesd == 1", VarTypes::Boolean);
    info[Vars::cesd2]                   = VarInfo("cesd2", "Cesd == 2", VarTypes::Boolean);
    info[Vars::cesd3]                   = VarInfo("cesd3", "Cesd == 3", VarTypes::Boolean);
    info[Vars::cesd4]                   = VarInfo("cesd4", "Cesd == 4", VarTypes::Boolean);
    info[Vars::cesd5]                   = VarInfo("cesd5", "Cesd == 5", VarTypes::Boolean);
    info[Vars::cesd6]                   = VarInfo("cesd6", "Cesd == 6", VarTypes::Boolean);
    info[Vars::cesd7]                   = VarInfo("cesd7", "Cesd == 7", VarTypes::Boolean);
    info[Vars::cesd8]                   = VarInfo("cesd8", "Cesd == 8", VarTypes::Boolean);
    info[Vars::cesd9]                   = VarInfo("cesd9", "Cesd == 9", VarTypes::Boolean);
    info[Vars::l2cesd1]                   = VarInfo("l2cesd1", "l2Cesd == 1", VarTypes::Boolean);
    info[Vars::l2cesd2]                   = VarInfo("l2cesd2", "l2Cesd == 2", VarTypes::Boolean);
    info[Vars::l2cesd3]                   = VarInfo("l2cesd3", "l2Cesd == 3", VarTypes::Boolean);
    info[Vars::l2cesd4]                   = VarInfo("l2cesd4", "l2Cesd == 4", VarTypes::Boolean);
    info[Vars::l2cesd5]                   = VarInfo("l2cesd5", "l2Cesd == 5", VarTypes::Boolean);
    info[Vars::l2cesd6]                   = VarInfo("l2cesd6", "l2Cesd == 6", VarTypes::Boolean);
    info[Vars::l2cesd7]                   = VarInfo("l2cesd7", "l2Cesd == 7", VarTypes::Boolean);
    info[Vars::l2cesd8]                   = VarInfo("l2cesd8", "l2Cesd == 8", VarTypes::Boolean);
    info[Vars::l2cesd9]                   = VarInfo("l2cesd9", "l2Cesd == 9", VarTypes::Boolean);
