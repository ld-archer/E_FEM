/** \file prep_ptax.sas
    ...
    for 2002 and 2004
    \weihanch 02/2015 for 2002 to 2012
************************************/
...
** 10/2016 - these variables are the same for 2014 (wave 12)
year1998, 2000. 
...
*/
data prep_ptax&yr;
   merge hrs.hrs&yr (in=_inf keep=hhidpn &v.xmod_hh
                                  &v.h075 &v.h076 &v.h077 &v.h186 &v.h187 &v.h188)
    ...
    nofindat=(&v.xmod_hh>0);  /* no finr for housing section */
...
/* 03/2015 Not sure how do impute for year 1998 & 2000 due to the non-availability in min and max value 
%prepimp(4,98,f)
%prepimp(5,00,g)
*/
%prepimp(6,02,h)
