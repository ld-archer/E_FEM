...
*/
data prep_ptax&yr;
   merge hrs.hrs&yr (in=_inf keep=hhidpn &v.xmod_f G3127 G3128b G3315 G3316b)
    ...
    nofindat=(&v.xmod_f>0);  /* no finr for housing section */
    ...
    ** AMOUNTS, BRACKETS, FLAGS **;
           ...
           if &v.h075=. or &v.h075>=9999998 then select (G3128b);
              when(1) do; &v.h076=0; &v.h077=499; end;
              when(2) do; &v.h076=500; &v.h077=500; end;
              when(3) do; &v.h076=501; &v.h077=1999; end;
              when(4) do; &v.h076=0; &v.h077=1999; end;
              when(5) do; &v.h076=2000; &v.h077=2000; end;
              when(6) do; &v.h076=2001; &v.h077=7499; end;
              when(7) do; &v.h076=7500; &v.h077=7500; end;
              when(8) do; &v.h076=7501; &v.h077=99999996; end;
              when(9) do; &v.h076=2001; &v.h077=99999996; end;
              when(98) do; &v.h076=0; &v.h077=99999996; end;
              otherwise;
           end;
 
 
           if &v.h186=. or &v.h186>=9999998 then select (G3316b);
