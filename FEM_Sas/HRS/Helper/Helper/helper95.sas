...
data help.helper&yr;
 ...
 length hpk&w.gkidp hps&w.gkidp $ 3;
  ...
  if dhlptype="1" then do; /* related kid/gkid who helped */
      %cleanhlp(hpk,2140, 2145,marv=,relv=2135A,oop9=999,vblksg=2137,dieopn=010)  /* kid variables */
  ...
  else do;  /* spouse of kid/gkid who helped */
      %cleanhlp(hps,2140, 2145,marv=,relv=2135A,oop9=999,vblksg=2137,dieopn=010)  /* kid spouse variables */
