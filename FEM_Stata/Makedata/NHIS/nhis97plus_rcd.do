...
capture log close
log using nhis9705_rcd.log, replace
...
*         Feb, 2005: update to 2010 NHIS data
*************************************************************************
...
* Have to deal with renaming of the origin variable
...
save $outdata/nhis97plus_selected.dta, replace
