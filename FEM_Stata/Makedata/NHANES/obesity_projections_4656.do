...
Change from aweight to pweight
*/
...
* Estimate the quantile regressions for all 50-54 year olds in 2003-2004
...
CURRENTLY NOT NEEDED SINCE BMI > 40 IS IN LESS THAN THE 95th PERCENTILE

use $outdata/nhanes.dta, replace
keep if age5054 == 1

local m = 952
forvalues x = .952 (.002) .998 {
	tempfile percentile_`m'
...
save $outdata/obesity_projections_4656.dta, replace
