...
/**** ADJUST COVARIATES FOR MODELS IN PROGRAM init_transition.do ****/
	...
	takestring, oldlist($allvars_hlth) newname("allvars_hearte") extlist("lhearte fheart50 lstroke llunge lcancre liadl1 liadl2p ladl1 ladl2 ladl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_stroke") extlist("lstroke fstrok50 lstroke llunge liadl1 liadl2p ladl1 ladl2 ladl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_cancre") extlist("lhearte lstroke lcancre lhibpe ldiabe llunge fcanc50 liadl1 liadl2p ladl1 ladl2 ladl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_hibpe")  extlist("lhearte lstroke lcancre lhibpe llunge fhibp50 liadl1 liadl2p ladl1 ladl2 ladl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_diabe")  extlist("lhearte lstroke lcancre lhibpe ldiabe llunge fdiabe50 liadl1 liadl2p ladl1 ladl2 ladl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_lunge")  extlist("lhearte lstroke lcancre lhibpe ldiabe llunge flung50 liadl1 liadl2p ladl1 ladl2 ladl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_memrye") extlist("lhearte lstroke lcancre lhibpe ldiabe llunge flung50 ")
...
global allvars_volhours lvolhours age_yrs agesq male black hispan hsless college lloghatotax llogiearnx lhicap ladl1p liadl1p lnumdisease lwidowed fsingle50 nkid_liv10mi suburb exurb catholic jewish reloth relnone rel_notimp rel_someimp           
global allvars_parhelphours lparhelphours age_yrs agesq male black hispan hsless college lloghatotax llogiearnx lhicap ladl1p liadl1p lnumdisease lwidowed fsingle50 nkid_liv10mi suburb exurb            
global allvars_gkcarehrs lgkcarehrs age_yrs agesq male black hispan hsless college lloghatotax llogiearnx lhicap ladl1p liadl1p lnumdisease lwidowed fsingle50 nkid_liv10mi suburb exurb            
