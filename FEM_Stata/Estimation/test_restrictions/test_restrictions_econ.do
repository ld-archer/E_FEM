...
global ster    				"$local_path/Estimates/health_restr"
global outdir 				"$local_path/Estimates/health_restr"
...
cap log close
log using "$workdir/test_restrictions_econ.log", replace
...
*** FOR CHRONIC CONDITIONS AND ORDINAL OUTCOMES
	...
	takestring, oldlist($allvars_hlth) newname("allvars_stroke") extlist("lstroke fstroke")
	...
	takestring, oldlist($allvars_hlth) newname("allvars_memrye") extlist("")
	...
	local restr_hearte lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
	local restr_stroke lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
	local restr_cancre lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
	local restr_hibpe lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
	local restr_diabe lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
	local restr_lunge lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
	local restr_died lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim 
	
	
	local restr_smkstat lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
	local restr_funcstat lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
	local restr_logbmi lwork llogiearnx lwlth_nonzero lloghatotax lssiclaim lssclaim ldbclaim  
