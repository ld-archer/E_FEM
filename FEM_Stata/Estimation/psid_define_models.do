...
/*	takestring, oldlist($allvars_econ1) newname("allvars_ssclaim1") extlist("l2ssiclaim l2ssclaim l2smoken l2age35l l2age3544 l2age4554 l2age5564 l2age6574 l2age75p l2anyexercise")
	global allvars_ssclaim $allvars_ssclaim1 $nra $lvars_marr
*/	
	...
	takestring, oldlist($allvars_econ2) newname("allvars_wlth_nonzero") extlist("l2smoken l2ssiclaim l2anyexercise")
        takestring, oldlist($allvars_econ2) newname("allvars_proptax_nonzero")
	...
	takestring, oldlist($allvars_econ2) newname("allvars_hicap") extlist("l2smoken l2ssiclaim l2anyexercise")
        takestring, oldlist($allvars_econ2) newname("allvars_proptax")
