...
global bin_hlth stroke hearte anyexercise cancre hibpe diabe lunge smoke_start smoke_stop binge_3permo /* k6severe */
* Binary econ outcomes - removing dbclaim nhmliv; anyhi (using inscat), work (using two-stage model)
global bin_econ ssclaim diclaim  ssiclaim hicap_nonzero igxfr_nonzero wlth_nonzero fullparttime
global ols logbmi hicap igxfr 
...
*** values of econ variables at time t-1  - Removing: ldbclaim lnhmliv llogiearnx lwlth_nonzero lloghatotax
	global lvars_claim l2diclaim l2ssiclaim l2ssclaim 
...
*** Ordered Health Outcomes ***
  ...
  * Smoking status
	...
	* cross-sectional life satisfaction ordered probit
	global allvars_satisfaction $dvars age agesq cancre icancre diabe idiabe hearte ihearte hibpe ihibpe lunge ilunge stroke istroke adl1 adl2 adl3p iadl1 iadl2p married cohab male_married male_cohab
...
local select_died !l2died & year >= 2007
local select_partdied l2mstat_new != 1
local select_hearte !died & !l2hearte & year >= 2007
local select_stroke !died & !l2stroke & year >= 2007
local select_cancre !died & !l2cancre
local select_hibpe !died & !l2hibpe & year >= 2007
...
local select_ssclaim !died & age >= 62
...
local select_smoke_start !died & !l2smoken & year >= 2007
local select_smoke_stop !died & l2smoken & year >= 2007
...
local select_binge_3permo !l2died & year >= 2007
