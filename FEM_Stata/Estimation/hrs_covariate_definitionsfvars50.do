...
// BMI variables
global bmivars llogbmi_l30 llogbmi_30p flogbmi50_l30 flogbmi50_30p
...
** add waves 8 and 9 for validation
  global allvars_econ3 $dvars la6 la7 la7p $lvars_hlth $lvars_econ $fvars w3 w4 w5 w6 w7 w8 w9 w10 logdeltaage $rvars
