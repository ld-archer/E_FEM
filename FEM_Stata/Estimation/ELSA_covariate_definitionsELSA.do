...
global allvars_arthre       $dvars $lvars_age $bmivars `lvars_smoke' l2hearte l2stroke l2hibpe l2diabe l2work
global allvars_psyche       $dvars $lvars_age $bmivars `lvars_smoke' l2hearte l2stroke l2cancre l2hibpe l2diabe l2work
global allvars_asthmae      $dvars $lvars_age $bmivars `lvars_smoke' `lvars_drink' l2lunge
...
global allvars_smoke_start  $dvars $lvars_age $lvars_econ l2adl1 l2adl2 l2adl3p l2iadl1 l2iadl2p
global allvars_smoke_stop   $dvars $lvars_age $lvars_econ l2adl1 l2adl2 l2adl3p l2iadl1 l2iadl2p
...
*** Logbmi & other health
global allvars_logbmi       $dvars $lvars_age $bmivars l2smokev l2smoken `lvars_exercise'
...
*** Economic
global allvars_work         $dvars $lvars_age $bmivars $lvars_hlth $lvars_econ `lvars_exercise' l2psyche l2arthre l2parkine
