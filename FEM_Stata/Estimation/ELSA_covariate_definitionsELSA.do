...
global allvars_smoke_start  $dvars $lvars_age $bmivars `lvars_drink' $lvars_econ l2psyche 
global allvars_smoke_stop   $dvars $lvars_age $bmivars `lvars_drink' $lvars_econ l2psyche 
...
global allvars_smokef       $dvars $lvars_age logbmi drink drinkd1 drinkd2 drinkd3 drinkd4 atotf itearn adl1 adl2 adl3p iadl1 iadl2p psyche
...
*** Logbmi & other health
global allvars_logbmi       $dvars $lvars_age $bmivars $lvars_hlth `lvars_smoke' `lvars_drink' `lvars_exercise' l2psyche
