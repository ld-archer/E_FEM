...
/**** ADJUST COVARIATES FOR MODELS IN PROGRAM init_transition.do ****/
	...
	takestring, oldlist($allvars_hlth) newname("allvars_hearte") extlist("l2hearte fheart50 l2stroke l2lunge l2cancre l2hearta l2iadl1 l2iadl2p l2adl1 l2adl2 l2adl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_stroke") extlist("l2stroke fstrok50 l2lunge l2iadl1 l2iadl2p l2adl1 l2adl2 l2adl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_cancre") extlist("l2hearte l2stroke l2cancre l2hibpe l2diabe l2lunge l2hearta fcanc50 l2iadl1 l2iadl2p l2adl1 l2adl2 l2adl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_hibpe")  extlist("l2hearte l2stroke l2cancre l2hibpe l2lunge l2hearta fhibp50 l2iadl1 l2iadl2p l2adl1 l2adl2 l2adl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_diabe")  extlist("l2hearte l2stroke l2cancre l2hibpe l2diabe l2lunge l2hearta fdiabe50 l2iadl1 l2iadl2p l2adl1 l2adl2 l2adl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_lunge")  extlist("l2hearte l2stroke l2cancre l2hibpe l2diabe l2lunge l2hearta flung50 l2iadl1 l2iadl2p l2adl1 l2adl2 l2adl3p ")
	takestring, oldlist($allvars_hlth) newname("allvars_memrye") extlist("l2hearte l2stroke l2cancre l2hibpe l2diabe l2lunge l2hearta flung50 ")
	takestring, oldlist($allvars_hlth) newname("allvars_deprsymp") extlist("l2hearte l2stroke l2cancre l2hibpe l2diabe l2lunge")
	takestring, oldlist($allvars_hlth) newname("allvars_hearta") extlist("l2hearte fheart50 l2lunge l2cancre l2iadl1 l2iadl2p flogbmi50_l30 flogbmi50_30p")
	global allvars_hearta $allvars_hearta fheart50 black_l2heartae hispan_l2heartae hsless_l2heartae college_l2heartae male_l2heartae male_hsless_l2heartae male_black_l2heartae male_hispan_l2heartae l2age65l_l2heartae l2age6574_l2heartae l2age75p_l2heartae l2hibpe_l2heartae l2diabe_l2heartae l2smoken_l2heartae l2widowed_l2heartae fstrok50_l2heartae fcanc50_l2heartae fhibp50_l2heartae fdiabe50_l2heartae flung50_l2heartae fheart50_l2heartae fsmokev_l2heartae fsmoken50_l2heartae l2logbmi_l30_l2heartae l2logbmi_30p_l2heartae logdeltaage_l2heartae
...
* Model the cholesterol treatment variables
global allvars_rxchol_start $dvars l2age65l l2age6574 l2age75p l2hearte l2stroke l2diabe l2hibpe $fvars $bmivars
global allvars_rxchol_stop $dvars l2age65l l2age6574 l2age75p l2hearte l2stroke l2diabe l2hibpe $fvars $bmivars
	...
	*global allvars_smkstat $allvars_hlth
	...
	global allvars_chfe $allvars_hearte l2hearte fheart50
	
	*Model the new AD from HRS wave 10 & 11 data
	global allvars_alzhe male hsless college black hispan l2age70l l2age7074 l2age7579 l2age80p l2iadl1 l2iadl2p  l2cogstate1 l2cogstate2 l2hibp_stroke 
 
	*global allvars_alzhe  $allvars_hlth l2cogstate1 l2cogstate2 l2selfmem1 l2selfmem2
	...
	*** 
	global allvars_cogstate l2cogstate1 l2cogstate2 $allvars_hlth l2selfmem1 l2selfmem2 
**	global allvars_selfmem  l2selfmem1 l2selfmem2 $allvars_hlth
...
*** FOR TRANSFER OUTCOMES
  global allvars_tcamt_cpl age_yrs agesq male married black hispan fkids hsless college l2tcamt_cpl l2ihs_hwealth_cpl flogiearnx l2ihs_hicap_cpl l2hicap_nonzero l2adl1p l2iadl1p l2numdisease
  global allvars_ihs_tcamt_cpl age_yrs agesq male married black hispan fkids hsless college l2ihs_hwealth_cpl flogiearnx l2ihs_hicap_cpl l2hicap_nonzero l2adl1p l2iadl1p l2numdisease
  global allvars_helphoursyr l2helphoursyr age_yrs agesq male married black hispan fkids hsless college l2ihs_hwealth_cpl flogiearnx l2ihs_hicap_cpl l2hicap_nonzero l2iadl1 l2iadl2p l2adl1 l2adl2 l2adl3p l2hearte l2stroke l2cancre l2hibpe l2diabe l2lunge nkid_liv10mi
...
global allvars_proptax_nonzero $allvars_proptax_nonzero nhmliv l2proptax_nonzero /*lproptax_nonzero*/
global allvars_proptax $allvars_proptax nhmliv l2proptax /*lproptax*/
...
global allvars_iearnuc $allvars_iearnuc l2logiearnuc flogiearnuc
disp "$allvars_iearnuc"	
